...
export const SalesmanPerformanceView: React.FC<SalesmanPerformanceProps> = ({ salesmen }) => {
  ...
  const handleSavePDF = () => {
    alert('Exporting Salesman Performance Report as PDF...');
  };
    ...
    <div className="space-y-5 max-w-full font-sans">
      ...
      <div className="bg-white rounded-xl border border-gray-200/80 shadow-2xs overflow-hidden">
        <div className="px-5 py-3 border-b border-gray-100 flex items-center justify-between bg-gray-50/50">
          <span className="text-xs font-bold text-gray-800">Salesman Performance Table ({filteredSalesmen.length} Total)</span>
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-gray-100/70 text-[10px] font-bold text-gray-600 uppercase tracking-wider border-b border-gray-200">
                <th className="py-2.5 px-4">Salesman Name & Designation</th>
